...
export function buildOnboardingPlan(answers: string[]): OnboardingPlan {
  ...
  return {
    ...
    minionConcept: `A platform-native Minion for ${business}: ${mission}. It starts as a reviewable blueprint and can later gain controlled channels, apps, and an cloud-computer-style workspace only after explicit approval.`,
    ...
    workstationPlan: 'Future Cloud-computer-style workspace plan: browser, files, apps, connected accounts, visible screen, stop controls, and owner takeover before sensitive actions.',
